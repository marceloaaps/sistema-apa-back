...
public class Animais {
    ...
    public Animais(Long id, String nome, Integer idade, String raca, Long idSaude, String comportamento, String historico, LocalDate dataCadastro, boolean disponivelParaAdocao) {
        this.id = id;
        this.nome = nome;
        this.idade = idade;
        this.raca = raca;
