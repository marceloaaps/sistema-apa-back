...
class EventControllerTest {
    ...
    void shouldGetEventByIdSuccessfully() throws Exception {
        ...
        List<AnimalDto> animais = Arrays.asList(
                new AnimalDto(10L, "Rex", 3, "Labrador", 456L, "Calmo e amigável", "Encontrado na rua, saudável", LocalDate.of(2023, 4, 1), true),
                new AnimalDto(20L, "Mimi", 2, "Poodle", 457L, "Brincalhona", "Resgatada de um abrigo", LocalDate.of(2023, 5, 10), true)
        );
